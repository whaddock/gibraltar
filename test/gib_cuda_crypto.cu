...
__device__ byte gf_log_d[256];
__device__ byte gf_ilog_d[256];
...
__device__ __constant__ uint32_t aes_Te1[256] = {
...
__device__ __constant__ uint32_t aes_Te2[256] = {
...
__device__ __constant__ uint32_t aes_Te3[256] = {
